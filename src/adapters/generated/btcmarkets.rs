...
pub static SPEC: ApiSpec = ApiSpec {
    ...
    endpoints: &[
        ...
        Endpoint {
            base: "https://api.btcmarkets.net",
            verb: "GET",
            key: "markets/{marketId}/orderbook",
