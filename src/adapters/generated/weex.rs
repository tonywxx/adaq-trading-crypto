...
pub static SPEC: ApiSpec = ApiSpec {
    ...
    endpoints: &[
        ...
        Endpoint {
            base: "https://api-spot.weex.com",
            verb: "GET",
            key: "api/v3/market/ticker/bookTicker",
        ...
        Endpoint {
            base: "https://api-spot.weex.com",
            verb: "GET",
            key: "api/v3/account/transferRecords",
        ...
        Endpoint {
            base: "https://api-spot.weex.com",
            verb: "POST",
            key: "api/v3/account/fundingBills",
        ...
        Endpoint {
            base: "https://api-contract.weex.com",
            verb: "GET",
            key: "capi/v3/market/exchangeInfo",
        ...
        Endpoint {
            base: "https://api-contract.weex.com",
            verb: "GET",
            key: "capi/v3/market/ticker/24hr",
        ...
        Endpoint {
            base: "https://api-contract.weex.com",
            verb: "GET",
            key: "capi/v3/market/ticker/bookTicker",
        ...
        Endpoint {
            base: "https://api-contract.weex.com",
            verb: "GET",
            key: "capi/v3/account/commissionRate",
        ...
        Endpoint {
            base: "https://api-contract.weex.com",
            verb: "GET",
            key: "capi/v3/account/accountConfig",
        ...
        Endpoint {
            base: "https://api-contract.weex.com",
            verb: "GET",
            key: "capi/v3/account/symbolConfig",
        ...
        Endpoint {
            base: "https://api-contract.weex.com",
            verb: "GET",
            key: "capi/v3/account/position/allPosition",
        ...
        Endpoint {
            base: "https://api-contract.weex.com",
            verb: "GET",
            key: "capi/v3/account/position/singlePosition",
        ...
        Endpoint {
            base: "https://api-contract.weex.com",
            verb: "POST",
            key: "capi/v3/account/marginType",
        ...
        Endpoint {
            base: "https://api-contract.weex.com",
            verb: "POST",
            key: "capi/v3/account/positionMargin",
        ...
        Endpoint {
            base: "https://api-contract.weex.com",
            verb: "POST",
            key: "capi/v3/account/modifyAutoAppendMargin",
