//! WOOFI PRO (`woofipro`) 转译适配器 — 由 `scripts/gen_adapters.py`
...
pub static SPEC: ApiSpec = ApiSpec {
    ...
    version: "v1",
    rate_limit_ms: 100,
    has: &["cancelAllOrders", "cancelOrder", "cancelOrders", "createLimitOrder", "createMarketOrderWs", "createOrder", "createOrderWithTakeProfitAndStopLoss", "createOrders", "createReduceOnlyOrder", "createStopLossOrder", "createTakeProfitOrder", "createTriggerOrder", "editOrder", "fetchBalance", "fetchClosedOrders", "fetchCurrencies", "fetchCurrenciesWs", "fetchDeposits", "fetchDepositsWithdrawals", "fetchFundingHistory", "fetchFundingInterval", "fetchFundingRate", "fetchFundingRateHistory", "fetchFundingRates", "fetchL2OrderBook", "fetchLedger", "fetchLeverage", "fetchMarkets", "fetchMyTrades", "fetchOHLCV", "fetchOpenInterest", "fetchOpenInterests", "fetchOpenOrders", "fetchOrder", "fetchOrderBook", "fetchOrderTrades", "fetchOrders", "fetchPosition", "fetchPositions", "fetchStatus", "fetchTicker", "fetchTickers", "fetchTime", "fetchTrades", "fetchTradingFees", "fetchTransactions", "fetchWithdrawals", "privateAPI", "publicAPI", "setLeverage", "swap", "withdraw"],
    endpoints: &[
...
crate::impl_generated_adapter!(Woofipro, &SPEC);
