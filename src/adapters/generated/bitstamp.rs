...
pub static SPEC: ApiSpec = ApiSpec {
    ...
    endpoints: &[
        ...
        Endpoint {
            base: "https://www.bitstamp.net/api",
            verb: "GET",
            key: "trade_history/{pair}",
            path: "trade_history/{pair}",
            auth: true,
        },
        Endpoint {
            base: "https://www.bitstamp.net/api",
