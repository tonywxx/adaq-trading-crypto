...
pub static SPEC: ApiSpec = ApiSpec {
    ...
    endpoints: &[
        ...
        Endpoint {
            base: "https://api.bitopro.com/v3",
            verb: "GET",
            key: "provisioning/trading-pairs",
        ...
        Endpoint {
            base: "https://api.bitopro.com/v3",
            verb: "GET",
            key: "wallet/withdraw/{currency}/{serial}",
        ...
        Endpoint {
            base: "https://api.bitopro.com/v3",
            verb: "GET",
            key: "wallet/withdraw/{currency}/id/{id}",
        ...
        Endpoint {
            base: "https://api.bitopro.com/v3",
            verb: "GET",
            key: "wallet/depositHistory/{currency}",
        ...
        Endpoint {
            base: "https://api.bitopro.com/v3",
            verb: "GET",
            key: "wallet/withdrawHistory/{currency}",
    ...
    maker: 0.001,
    timeframes: &[
        "1m", "5m", "15m", "30m", "1h", "3h", "6h", "12h", "1d", "1w", "1M",
    ],
    kind: MarketKind::Cex,
};
