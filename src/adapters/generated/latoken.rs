...
pub static SPEC: ApiSpec = ApiSpec {
    ...
    endpoints: &[
        Endpoint {
            base: "https://api.latoken.com",
            verb: "GET",
            key: "book/{currency}/{quote}",
        ...
        Endpoint {
            base: "https://api.latoken.com",
            verb: "GET",
            key: "trade/history/{currency}/{quote}",
        ...
        Endpoint {
            base: "https://api.latoken.com",
            verb: "GET",
            key: "auth/account/currency/{currency}/{type}",
        ...
        Endpoint {
            base: "https://api.latoken.com",
            verb: "GET",
            key: "auth/order/pair/{currency}/{quote}",
        ...
        Endpoint {
            base: "https://api.latoken.com",
            verb: "GET",
            key: "auth/order/pair/{currency}/{quote}/active",
        ...
        Endpoint {
            base: "https://api.latoken.com",
            verb: "GET",
            key: "auth/stopOrder/getOrder/{id}",
        ...
        Endpoint {
            base: "https://api.latoken.com",
            verb: "GET",
            key: "auth/trade/pair/{currency}/{quote}",
        ...
        Endpoint {
            base: "https://api.latoken.com",
            verb: "GET",
            key: "auth/trade/fee/{currency}/{quote}",
        ...
        Endpoint {
            base: "https://api.latoken.com",
            verb: "POST",
            key: "auth/order/cancelAll/{currency}/{quote}",
